namespace PaladinProject.Models
{
    public class Item
    {
        ...
        public string Quality { get; set; } // Can be used for CSS classes/colors
        ...
        // Categorization
        public string Category { get; set; } // e.g. "Consumable > Flask"
        public string Faction { get; set; }  // e.g. "None", "Alliance", "Horde"
