        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JsonLayout = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataPresets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondIcon = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TreeKey = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TalentNodeStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TalentBuildNodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TalentBuildNodes_TalentBuilds_BuildId",
                        column: x => x.BuildId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_ProductImages_ThumbnailImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentPages_Section_Slug",
                table: "ContentPages",
                columns: new[] { "Section", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DataPresets_Entity_Name",
                table: "DataPresets",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_ProductImages_Product_SortOrder",
                table: "ProductImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TalentBuildNodes_BuildId_NodeId",
                table: "TalentBuildNodes",
                columns: new[] { "BuildId", "NodeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TalentBuilds_TreeKey_Name",
                table: "TalentBuilds",
                columns: new[] { "TreeKey", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TalentNodeStates_TreeKey_NodeId",
                table: "TalentNodeStates",
                columns: new[] { "TreeKey", "NodeId" },
                unique: true);
